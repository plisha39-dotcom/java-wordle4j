...
public class Wordle {
    ...
    private static void runGame(Scanner scanner, PrintWriter log) {
        try {
            ...
            while (!game.isFinished()) {
                ...
                if (command.isEmpty()) {
                    handleSuggestCommand(game, log);
                    continue;
                }
                handleGuessCommand(game, input, log);
            }
    ...
    private static void handleSuggestCommand(WordleGame game, PrintWriter log) {
        try {
    ...
    private static void handleGuessCommand(WordleGame game, String input, PrintWriter log) {
        try {
